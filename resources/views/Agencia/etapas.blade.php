                                                ...
                                                <table class="table table-hover table-centered table-nowrap mb-0">
                                                    @if(count($demandas) === 0)
                                                        ...
                                                        <tbody>
                                                            @foreach ($demandas as $key => $demanda )
                                                                @if ($isAdminAg > 0)
                                                                <tr class="trLink" style="cursor: pointer;" data-href="{{route('Agencia.criar_etapa_2', ['id' => $demanda->id])}}">
                                                                    <td class="actions">
                                                                        <a  href="{{route('Agencia.deletar_etapa_1', ['id' => $demanda->id])}}" class="btn btn-outline-secondary btn-sm edit deleteBt btnDanger" style="background-color: #5e5e5e" title="Deletar">
                                                                            <i class="fas fa-trash"></i>
                                                                        </a>
                                                                    </td>
                                                                    <td>
