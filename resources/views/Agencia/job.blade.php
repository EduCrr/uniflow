                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div style="display: flex">
                                                                ...
                                                                @if ($demanda->finalizada === 1 && $loggedUser->id === $demanda->criador_id)
                                                                        ...
                                                                        <div class="modal fade" id="modalReabirJob" tabindex="-1" role="dialog">
                                                                            <div class="modal-dialog" role="document">
                                                                                <div class="modal-content">
                                                                                    <form method="POST"action="{{route('Agencia.reaberto', ['id' => $demanda->id])}}">
                                                                                        @csrf
                                                                    ...
                                                                    @if($demanda->finalizada == 0)
                                                                        @if($demanda->entregue == 1 && $demanda->entregue_recebido == 0)
                                                                            <div class="form-check-inline my-2">
                                                                                <div class="form-check">
                                                                                    <form  method="POST" action="{{route('Agencia.Receber_alteracoes', ['id' => $demanda->id])}}">
                                                                                        @csrf
                                                                        ...
                                                                        @else
                                                                            @if($demanda->pausado == 1)
                                                                                <div class="form-check-inline my-2">
                                                                                    <div class="form-check">
                                                                                        <form  method="POST" action="{{route('Agencia.Retomar_action', ['id' => $demanda->id])}}">
                                                                                            @csrf
                                                                            ...
                                                                            @else
                                                                                <div class="form-check-inline my-2">
                                                                                    <div class="form-check adjustStatus">
                                                                                        <form  method="POST" action="{{route('Agencia.Pausar_action', ['id' => $demanda->id])}}">
                                                                                            @csrf
                                                                                            <div class="checkbox my-2">
                                                                                                <button type="submit"  class="stopJob submitQuest">Congelar job</button>
                                                                                            </div>
                                                                                        </form>
                                                                                        <form  method="POST" action="{{route('Agencia.Finalizar_action', ['id' => $demanda->id])}}">
                                                                                            @csrf
                                                                                            <div class="checkbox my-2">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="adjustBriefing">
                                                                        <h5 class="card-title comments">
                                                                            Job {{$item->status}} @if($item->finalizado != null)  <i class="mdi mdi-check-circle " style="color:#3dbb3d; font-size: 16px;"></i>  @endif
                                                                        </h5>
                                                                ...
                                                                <div class="row gx-3">
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3" id="alteracao">
                                                                            ...
                                                                            @if ($showAg && $loggedUser->id != $demanda->criador_id)
                                                ...
                                                <div class="col-xl-12">
                                                    @if(count($demanda['prazosDaPauta']) > 0)
                                                        <div class="adjustPautas">
                                                            <p><strong>Agência: {{$getAgencyAdmin->nome}}</strong></p>
                                                            <div class="progressiveBar">
                                                                <small class="float-end ms-2 font-size-12">{{$demanda->porcentagem}}%</small>
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="initalResume">
                                                                    ...
                                                                    @if ($showAg === true && $demanda->pausado == 0 && $demanda->recebido != 0)
                                                                                    ...
                                                                                    @if($item->sugerido != null)
                                                                                        ...
                                                                                        @if(!$showAg)
                                                                                            @if($item->aceitar_colaborador == 0 )
                                                                                                <form method="POST" action="{{route('Agencia.Aceitar_tempo_colaborador', ['id' => $item->id])}}">
                                                                                                    @csrf
                                                                                                    <input class="accept submitQuest activePauta" type="submit" value="Aceitar novo prazo">
                                                                                                </form>
                                                                                            @endif
