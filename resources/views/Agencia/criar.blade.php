                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="formCreate" style="margin-top: 15px" method="POST" action="{{route('Agencia.criar_action')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                        @csrf
                                        <div class="mb-3 row">
                                                ...
                                                <div class="">
                                                    <select id="inputC" name="colaborador" class="form-select select2" required>
                                                        @foreach ($colaboradores as $colaborador)
                                                            <option  @if (!empty(old('colaborador')) && in_array($marca->id, old('colaborador'))) selected  @endif value="{{ $colaborador->id }}">{{ $colaborador->nome }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">
