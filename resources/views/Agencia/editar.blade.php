                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form id="formEdut" style="margin-top: 15px" method="POST" action="{{route('Agencia.editar_action', ['id' => $demanda->id])}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                                            @csrf
                                                            <div class="mb-3 row">
                                                                <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="inputC" name="colaborador" class="form-select select2" required>
                                                                            <option  value="{{ $demanda->criador->id }}">{{ $demanda->criador->nome }}</option>
                                                                        </select>
                                                                        <div class="invalid-feedback">
