        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="d-none d-lg-inline-block">
                    ...
                    >
                        <i class="mdi mdi-home me-2 font-size-16"></i> <a class="{{ Request::is('dashboard') ? 'btnActive' : 'btnNotActive'  }}" href="{{route('dashboard')}}">Home</a>
                    </button>
                </div>
                <div class="d-none d-sm-block ms-1">
                    <div class="dropdown">
                        <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                            ...
                            <span class="d-none d-xl-inline-block ms-1 {{ Request::is('dashboard/jobs', 'dashboard/criar','dashboard/job/*' ) ? 'btnActive' : 'btnNotActive'  }}">Jobs</span>
