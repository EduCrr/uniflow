                                ...
                                <div class="card-body">
                                    ...
                                    <div class="general-label">
                                        <form class="row row-cols-lg-auto g-3 align-items-center" method="GET">
                                            ...
                                            <div class="mb-0 adjustSelects" >
                                                <a href="{{route('Jobs')}}" class="btn btn-danger ">Limpar</a>
                                                <button type="submit" class="btn btn-primary ">Pesquisar</button>
                                            </div>
                                            
                                            <div class="btnCreate">
                                                <a href="{{route('Job.criar')}}" class="btn ">Criar job</a>
                                            </div>
                                        </form>
                                                            ...
                                                            @foreach ($demandas as $key => $demanda )
                                                                ...
                                                                <tr class="trLink" style="cursor: pointer;" data-href="{{route('Job', ['id' => $demanda->id])}}">
                                                                    ...
                                                                    <td class="actions">
                                                                        ...
                                                                        <a  href="{{route('Job.delete', ['id' => $demanda->id])}}" class="btn btn-outline-secondary btn-sm edit deleteBt btnDanger" style="background-color: #a1a1a1" title="Deletar">
