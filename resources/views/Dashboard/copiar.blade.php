                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form id="formEdut" style="margin-top: 15px" method="POST" action="{{route('Job.copiar_action')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                                            @csrf
                                                            <div class="mb-3 row">
                                                                    ...
                                                                    <div class="">
                                                                        <select id="agencia" name="agencia" class="form-select select2" required>
                                                                            @foreach ($agencias as $agencia ) 
                                                                                <option @if($demanda->agencia_id === $agencia->id) selected @endif  value="{{ $agencia->id }}">{{ $agencia->nome }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        <div class="invalid-feedback">
