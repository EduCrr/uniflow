...
<p>{!! $body !!}</p>
<br/>
<a href="{{ $action_link }}">Criar nova senha</a> --}}
										...
										<tbody>
											...
											<tr>
												<td style="padding-top:10px;padding-bottom:20px" align="center" valign="middle">
													<img src="{{ asset('/assets/images/unicasa-photo.png') }}" width="200" height="40">
												</td>
											</tr>
											<tr>
																				...
																				<td width="540">
																					<table width="100%" cellspacing="0" cellpadding="0" border="0">
																						<tbody>
																							<tr>
																								<td valign="top">
																									<h3 style="margin:0px 0px 30px 0px;padding:0px;color:#252525;font-style:normal;font-size:25px;font-family:Calibri,Helvetica,Arial,sans-serif;font-weight:400;line-height:40px;text-decoration:none;text-transform:none;display:block;text-align:center;">{!! $titulo !!}</h3>
​
																									<p style="margin:0px 0px 15px 0px;padding:0px;color:#252525;font-style:normal;font-size:20px;font-family:Calibri,Helvetica,Arial,sans-serif;font-weight:400;line-height:25px;text-decoration:none;text-transform:none;display:block;text-align:center;">
																										@if(isset($nome))
																											Olá, {!! $nome !!}!<br>
																										@endif
																										{!! $body !!}
